...
test('container loc of paragraph-ui app archive, version already set') :-
    paragraph:contloc('paragraph-ui', warfile('paragraph-ui-0.0.1-SNAPSHOT.war'), '0.0.1-SNAPSHOT', file("/opt/paragraph/ParagraphUI/target/paragraph-ui-0.0.1-SNAPSHOT.war"), [], [ ag('paragraph'), ve('0.0.1-SNAPSHOT'), ad(paragraph_ui_target)]).

test('container loc of paragraph-ui app archive, version not set') :-
    paragraph:contloc('paragraph-ui', warfile('paragraph-ui-(version).war'),      '0.0.1-SNAPSHOT', file("/opt/paragraph/ParagraphUI/target/paragraph-ui-0.0.1-SNAPSHOT.war"), [], [ ag('paragraph'), ve('0.0.1-SNAPSHOT'), ad(paragraph_ui_target)]).

test('container loc of paragraph-ui pom.xml, version not set') :-
    paragraph:contloc('paragraph-ui', applfile('pom.xml'), '', file("/opt/paragraph/ParagraphUI/pom.xml"), [], [ ag('paragraph'), ve(''), ad(paragraph_ui) ]).
...
test('xpath -> xml file -> warfile : find the pom version of paragraph archives') :-
    paramval(pom_xml_version, Version, Val, [ag('paragraph'), ve('0.0.1-SNAPSHOT'), ad(paragraph_ui_target)]),
...
test('xpath -> xpath -> xml file -> warfile : find the parent pom version of paragraph archives') :-
    paramval(pom_xml_parent_version, Version, Val, [ag('paragraph'), ve('0.0.1-SNAPSHOT'), ad(paragraph_ui_target)]),
    Version = '0.0.1-SNAPSHOT',    % app version
