...
This is covered in detail in the following sections.

*** modeling using BDsl and reference data
...
*** automatically checking "contracts" with the help of datalog rules
