...
Contracts defined as datalog rules can infer additional facts as to whether a captured para_graph together with some 
calculated paramvs fullfill some expectations, for example:
